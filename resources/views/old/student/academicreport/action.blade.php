    ...
    <div class="content">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('academicreport.action', ['action' => $action]) }}" method="post"
                                ...
                                @foreach ($domains as $index => $domain)
                                    <tr>
                                        ...
                                        <td><input type="text" name="domain[{{ $domain }}][quarter_1]"
                                                value="{{ old('domain.' . $domain . '.quarter_1', $getdataReport[$domain]['quarter_1'] ?? '') }}"
                                                class="form-control">
                                            @error('domain.' . $domain . '.quarter_1')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td><input type="text" name="domain[{{ $domain }}][quarter_2]"
                                                value="{{ old('domain.' . $domain . '.quarter_2', $getdataReport[$domain]['quarter_2'] ?? '') }}"
                                                class="form-control">
                                            @error('domain.' . $domain . '.quarter_2')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td><input type="text" name="domain[{{ $domain }}][quarter_3]"
                                                value="{{ old('domain.' . $domain . '.quarter_3', $getdataReport[$domain]['quarter_3'] ?? '') }}"
                                                class="form-control">
                                            @error('domain.' . $domain . '.quarter_3')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td><input type="text" name="domain[{{ $domain }}][max_marks]"
                                                value="{{ old('domain.' . $domain . '.max_marks', $getdataReport[$domain]['max_marks'] ?? '') }}"
                                                class="form-control">
                                            @error('domain.' . $domain . '.max_marks')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        </td>
                                ...
                                @foreach ($domains as $index => $domain)
                                    <tr>
                                        ...
                                        <td><input type="text" name="Co_Curriculum[{{ $domain }}][quarter_1]"
                                                value="{{ old('Co_Curriculum.' . $domain . '.quarter_1', $getdataReportCur[$domain]['quarter_1'] ?? '') }}"
                                                class="form-control">
                                            @error('Co_Curriculum.' . $domain . '.quarter_1')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td><input type="text" name="Co_Curriculum[{{ $domain }}][quarter_2]"
                                                value="{{ old('Co_Curriculum.' . $domain . '.quarter_2', $getdataReportCur[$domain]['quarter_2'] ?? '') }}"
                                                class="form-control">
                                            @error('Co_Curriculum.' . $domain . '.quarter_2')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td><input type="text" name="Co_Curriculum[{{ $domain }}][quarter_3]"
                                                value="{{ old('Co_Curriculum.' . $domain . '.quarter_3', $getdataReportCur[$domain]['quarter_3'] ?? '') }}"
                                                class="form-control">
                                            @error('Co_Curriculum.' . $domain . '.quarter_3')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td><input type="text" name="Co_Curriculum[{{ $domain }}][Remarks]"
                                                value="{{ old('Co_Curriculum.' . $domain . '.Remarks', $getdataReportCur[$domain]['Remarks'] ?? '') }}"
                                                class="form-control">
                                            @error('Co_Curriculum.' . $domain . '.Remarks')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                    </tr>
