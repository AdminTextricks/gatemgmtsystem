        ...
        <div class="header">
            <ul class="nav nav-pills nav-pills-primary" role="tablist" id="myTab">
                <li class="nav-item m-1">
                    <a class="nav-link active student_byid" data-toggle="pill" href="#link1" role="tablist" data-id="";
                        id="general_info" style="font-size: .8rem; ">
                        General Info
                    </a>
                </li>
                @php
            ...
            <div class="tab-pane container fade" id="link6">
                <div class="footer-section">
                    ...
                    <div class="pdf-container"
                        ...
                        @if(!empty($recordBook))
                        <iframe src="{{ asset('recordbook'.'/'.$recordBook) }}"
                        ...
                        {{-- <iframe
                            src="{{ asset('pdfjs/web/viewer.html') }}?file={{ urlencode(asset('student_pdfs/student_record_book.pdf')) }}"
