                                ...
                                @foreach ($domains as $index => $domain)
                                    <tr>
                                        ...
                                        <td><input type="text"
                                                ...
                                                value="{{ old('domain.' . $domain . '.no_of_activities_assessed', $getdataReport[$domain]['no_of_activities_assessed'] ?? '') }}"
                                                class="form-control">
                                            @error('domain.' . $domain . '.no_of_activities_assessed')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td><input type="text" name="domain[{{ $domain }}][maxm_score]"
                                                value="{{ old('domain.' . $domain . '.maxm_score', $getdataReport[$domain]['maxm_score'] ?? '') }}"
                                                class="form-control">
                                            @error('domain.' . $domain . '.maxm_score')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td><input type="text" name="domain[{{ $domain }}][baseline_score]"
                                                value="{{ old('domain.' . $domain . '.baseline_score', $getdataReport[$domain]['baseline_score'] ?? '') }}"
                                                class="form-control">
                                            @error('domain.' . $domain . '.baseline_score')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td><input type="text" name="domain[{{ $domain }}][baseline_percentage]"
                                                value="{{ old('domain.' . $domain . '.baseline_percentage', $getdataReport[$domain]['baseline_percentage'] ?? '') }}"
                                                class="form-control">
                                            @error('domain.' . $domain . '.baseline_percentage')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td><input type="text" name="domain[{{ $domain }}][first_qtr_score]"
                                                value="{{ old('domain.' . $domain . '.first_qtr_score', $getdataReport[$domain]['first_qtr_score'] ?? '') }}"
                                                class="form-control">
                                            @error('domain.' . $domain . '.first_qtr_score')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td><input type="text"
                                                name="domain[{{ $domain }}][first_qtr_percentage]"
                                                value="{{ old('domain.' . $domain . '.first_qtr_percentage', $getdataReport[$domain]['first_qtr_percentage'] ?? '') }}"
                                                class="form-control">
                                            @error('domain.' . $domain . '.first_qtr_percentage')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td><input type="text" name="domain[{{ $domain }}][second_qtr_score]"
                                                value="{{ old('domain.' . $domain . '.second_qtr_score', $getdataReport[$domain]['second_qtr_score'] ?? '') }}"
                                                class="form-control">
                                            @error('domain.' . $domain . '.second_qtr_score')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td><input type="text"
                                                name="domain[{{ $domain }}][second_qtr_percentage]"
                                                value="{{ old('domain.' . $domain . '.second_qtr_percentage', $getdataReport[$domain]['second_qtr_percentage'] ?? '') }}"
                                                class="form-control">
                                            @error('domain.' . $domain . '.second_qtr_percentage')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td><input type="text" name="domain[{{ $domain }}][third_qtr_score]"
                                                value="{{ old('domain.' . $domain . '.third_qtr_score', $getdataReport[$domain]['third_qtr_score'] ?? '') }}"
                                                class="form-control">
                                            @error('domain.' . $domain . '.third_qtr_score')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td><input type="text"
                                                name="domain[{{ $domain }}][third_qtr_percentage]"
                                                value="{{ old('domain.' . $domain . '.third_qtr_percentage', $getdataReport[$domain]['third_qtr_percentage'] ?? '') }}"
                                                class="form-control">
                                                @error('domain.' . $domain . '.third_qtr_percentage')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                    </tr>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" name="Co-Curricular[no_of_activities_assessed]"
                                            ...
                                            value="{{ old('Co-Curricular.no_of_activities_assessed', $getdataReportCur['no_of_activities_assessed'] ?? '') }}"
                                            class="form-control">
                                        @error('Co-Curricular.no_of_activities_assessed')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror

                                    </td>
                                    <td><input type="text" name="Co-Curricular[baseline]" class="form-control"
                                            value="{{ old('Co-Curricular.baseline', $getdataReportCur['baseline'] ?? '') }}">
                                        @error('Co-Curricular.baseline')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </td>
                                    <td><input type="text" name="Co-Curricular[first_qtr]" class="form-control"
                                            value="{{ old('Co-Curricular.first_qtr', $getdataReportCur['first_qtr'] ?? '') }}">
                                        @error('Co-Curricular.first_qtr')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </td>
                                    <td><input type="text" name="Co-Curricular[second_qtr]"
                                            value="{{ old('Co-Curricular.second_qtr', $getdataReportCur['second_qtr'] ?? '') }}"class="form-control">
                                        @error('Co-Curricular.second_qtr')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </td>
                                    <td><input type="text" name="Co-Curricular[third_qtr]"
                                            value="{{ old('Co-Curricular.third_qtr', $getdataReportCur['third_qtr'] ?? '') }}"class="form-control">
                                        @error('Co-Curricular.third_qtr')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </td>
                                </tr>
