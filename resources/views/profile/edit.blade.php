...
@section('content')
            ...
            <div class="col-md-4">
                <div class="card card-user">
                    ...
                    <div class="card-bodyd">
                        <div class="author">
                            <a href="#">
                                <img class="avatar border-gray" src="{{ asset('paper/img/teacher_icon.png') }}"
                                    alt="...">
            ...
            <div class="col-md-8 text-center">
                <form class="col-md-12" action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <label class="col-md-3 col-form-label">{{ __('User Id') }}</label>
                                <div class="col-md-9">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                 ...
                                 <i class="fa fa-eye-slash" aria-hidden="true" id="showHidePassword"
                                    style="position: absolute; font-size:15px; right: 25px;
                                                    top: 20%; cursor: pointer; z-index:1032"></i>
    ...
    <script>
        ...
        $('#showHidePassword').on('click', function() {
            var userPassword = $('#password_confirmation');
